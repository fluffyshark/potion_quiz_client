...
export const PotionData = [
    ...
    {id: 18, image_bronze: potion_cards[18], image_silver: potion_cards[38], image_gold: potion_cards[58], amount: 0, discovered: false, level: 1, earnedPoints: 0, name: "MASS FREEZE"},
    {id: 19, image_bronze: potion_cards[19], image_silver: potion_cards[39], image_gold: potion_cards[59], amount: 0, discovered: false, level: 1, earnedPoints: 0, name: "GOLDEN POINTS"}
]
