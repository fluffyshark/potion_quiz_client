    ...
    <div className='startView'>
      ...
      <div className="startView_logo"><Logo /></div>
        ...
        <div className="startView_centerBtns">
          ...
          <Link /*to="/login"*/ to="/host" ><motion.div  whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.9 }} transition={{ type: "spring", stiffness: 400, damping: 17 }} onClick={() => hostGame()} className="startView_btns" id="play2"><HostBtn /></motion.div></Link>
        </div>
      </div>
