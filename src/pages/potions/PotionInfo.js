...
const potionInfoData = [
  ...
  {
    name: "REDECORATING",
    description: "Redesign your or another player's game layout.",
    flaskImage: flasks[8],
    effectTitle: "AVAILABLE OPTIONS",
    effectBronze: "Bronze: two design options", 
    effectSilver: "Silver: four design options", 
    effectGold: "Gold: seven design options", 
  },
  {
    name: "TRIPPLE POINTS",
